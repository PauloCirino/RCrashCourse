...
#   theta<-pseudoinverse(xt) %*% yt
  ...
  par(new=T)
  plot(x00,y_hat2,type='b', col = 'green',xlim=c(0,6),ylim=c(-1,1),xlab = '',ylab='')
  par(new=T)
  plot(x00[train[((0.7*20)+1):(20)]],y_hat,type='p',pch = 21,bg = 'green',xlim=c(0,6),ylim=c(-1,1),xlab = 'x',ylab='')
  par(new=T)
